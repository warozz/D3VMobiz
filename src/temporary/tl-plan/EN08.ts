export default {
      ...
      "items": [
        {
          ...
          "subItems": [
            {
              "name": "รับฮิบะห์ พร้อมเงินปันผลจ่ายเมื่อสัญญาสิ้นสุด (ถ้ามี)",
              "percentIncome": "110%*",
              "income": "{{income1}}"
            }
          ]
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val0 = utils.numFormat(Math.round( utils.formatInt(sum) * 1.1)); //ครบสัญญาคืนเงิน 110% ของทุนประกัน
