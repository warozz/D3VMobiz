export default {
  ...
  "info": {
    ...
    "section2": {
      ...
      "data": [{
        ...
        "type": "image",
        "value": "assets/img/projectform/graph/01/01_graph21.png",
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val1 = utils.numFormat(Math.round( utils.formatInt( sum )  * 1.0 )) ;
    const val2 = utils.numFormat(Math.round( utils.formatInt( sum )  * 1.0 )) ;
    const val3 = utils.numFormat(Math.round( utils.formatInt( sum )  * 1.0 )) ;
    const val4 = utils.numFormat(Math.round( utils.formatInt( sum )  * 1.0 )) ;
