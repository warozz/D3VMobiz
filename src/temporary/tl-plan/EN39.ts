export default {
  ...
  "info": {
    ...
    "section2": {
      ...
      "data": [{
        ...
        "type": "image",
        "value": "assets/img/projectform/graph/03/03_graphEN13.png",
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val1 = utils.numFormat(Math.round(utils.formatInt(sum)*2));
    const val2 = utils.numFormat(Math.round(utils.formatInt(sum)*2.06));
