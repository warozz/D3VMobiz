export default {
  ...
  "info": {
    ...
    "section2": {
      ...
      "data": [{
        ...
        "type": "image",
        "value": "assets/img/projectform/graph/02/02_graph40.png",
      ...
      "items": [
        {
          ...
          "subItems": [
            {
              "name": "1%* ตั้งแต่วันครบรอบปีกรมธรรม์ที่ 1-5 รวม 5 ครั้ง",
              "percentIncome": "5%*",
              "income": "{{income1}}"
            },
            {
  ...
  "calculate": (sum, prospect, utils, quatation) => {
    ...
    let aa = utils.formatInt(fixage) + 6;											
		...
		const val6 = utils.numFormat(Math.round(utils.formatInt(sum)*0.05));								
