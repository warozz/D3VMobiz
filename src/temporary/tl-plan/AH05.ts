export default {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "iconText": "**",
          "color": "c-blue",
          "message": "หากผู้เอาประกันภัยเสียชีวิตโดยที่ยังได้รับเงินบำนาญไม่ครบ 15 ปี บริษัทฯ จะจ่ายเงินบำนาญที่เหลืออยู่ในครั้งเดียวให้ โดยมูลค่าจะเท่ากับ มูลค่าปัจจุบันของจำนวนเงินบำนาญที่ยังไม่ได้จ่ายจนครบ 15 ปี {{extendMessage1}}"
        },
        {
          "iconText": "***",
          "color": "c-blue",
  ...
  "calculate": (sum, prospect, utils) => {
    const val0 = sum;
    const val1 = Math.round( utils.formatInt( sum ) * 0.1 );
    const val2 = Math.round( utils.formatInt( sum ) * 3.1 );
    const val3 = Math.round( utils.formatInt( sum ) * 0.0084 );
    const val4 = Math.round( utils.formatInt( sum ) * 3.1248 );
