export default {
  "name": "กรมธรรม์พิเศษเพื่อคนพิการ 20/1 [มีเงินปันผล]",
  "info": {
    "section1": null,
    "section2": {
      "css": {
      ...
      "data": [{
        ...
        "type": "image",
        "value": "assets/img/projectform/graph/03/03_graph5.png",
  ...
  "calculate": (sum, prospect, utils) => {
    const val0 = utils.numFormat(sum); // คืนเงิน 100 %
    // const val1 = utils.numFormat(sum);	
    // const val2 = utils.numFormat(sum);
