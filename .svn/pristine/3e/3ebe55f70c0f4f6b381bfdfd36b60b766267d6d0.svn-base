export default {
    ...
    "info": {
      ...
      "section2": {
        ...
        "data": [{
          ...
          "type": "text",
          "value": "เบี้ยประกันภัยสำหรับการประกันชีวิตที่ได้ชำระมาแล้วทั้งหมด หักด้วยเงินบำนาญที่บริษัทจ่ายไปแล้ว**",
          "css": {
            "margin-top": "33px",
            "margin-left": "135px",
            "font-size": "18px",
          ...
          "type": "image",
          "value": "assets/img/projectform/graph/01/A1_90-1(AS90).png",
    ...
    "summary": [
      {
        ...
        "items": [
          {
            "name": "ตั้งแต่วันครบรอบปีกรมธรรม์ 1 ถึงอายุ 85 ปี",
            "percentIncome": null,
            "income": null,
            "subItems": [
              {
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            "iconText": "***",
            "color": "c-blue",
            "message": "ผู้เอาประกันภัยสามารถเลือกรับเงินบำนาญเป็นรายปี ปีละ {{income1}} บาท {{extendMessage2}} ตั้งแต่วันครบรอบปีกรมธรรม์ที่ 1 ไปจนถึงวันครบรอบปีกรมธรรม์ที่อายุครบ 90 ปี"
          }
        ]
      },
      {
    ...
    "calculate": (sum, prospect, utils, quatation) => {
      ...
      const age2 = 90 - Number(prospect.age);
