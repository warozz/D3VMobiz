export default {
  ...
  "info": {
    ...
    "section2": {
      ...
      "data": [{
        ...
        "type": "image",
        "value": "assets/img/projectform/graph/01/graph_EN36.png",
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val2 =  utils.numFormat(Math.round( utils.formatInt( sum )  * 1.4 ));
    const val3 =  utils.numFormat(Math.round( utils.formatInt( sum )  * 1.6 ));
    const val4 =  utils.numFormat(Math.round( utils.formatInt( sum )  * 1.8 ));
    const val5 =  utils.numFormat(Math.round( utils.formatInt( sum )  * 2 ));
