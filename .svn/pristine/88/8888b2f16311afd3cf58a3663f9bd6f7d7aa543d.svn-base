export default {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "iconText": "***",
          "color": "c-blue",
          "message": "ผู้เอาประกันภัยสามารถเลือกรับเงินบำนาญเป็นรายปี ปีละ {{income1}} บาท {{extendMessage2}} ตั้งแต่วันครบรอบปีกรมธรรม์ที่ผู้เอาประกันภัยอายุครบ 55 ปี ไปจนถึงวันครบรอบปีกรมธรรม์ที่อายุครบ 90 ปี"
        }
      ]
    },
    {
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val2 = Math.round( utils.formatInt( sum ) * 3.6 );
    const val3 = Math.round( utils.formatInt( sum ) * 0.0084 );
    const val4 = Math.round( utils.formatInt( sum ) * 3.6288 );
