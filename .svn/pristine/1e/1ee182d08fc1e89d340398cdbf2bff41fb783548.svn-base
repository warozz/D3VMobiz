export default {
      ...
      "items": [
        ...
        },
        {
          ...
          subItems: [
            ...
            {
              name: "รวมรับเงินบำนาญรายเดือนตลอดสัญญาสูงสุด 432 งวด",
              percentIncome: "544.32%*",
              income: "{{income4}}"
            }
          ]
        }
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "iconText": "***",
          "color": "c-blue",
          "message": "ผู้เอาประกันภัยสามารถเลือกรับเงินบำนาญเป็นรายปี ปีละ {{income1}} บาท {{extendMessage2}} ตั้งแต่วันครบรอบปีกรมธรรม์ที่ผู้เอาประกันภัยอายุครบ {{minAge}} ปี ไปจนถึงวันครบรอบปีกรมธรรม์ที่อายุครบ {{maxAge}} ปี"
        }
      ]
    },
    {
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val2 = Math.round( utils.formatInt( sum ) * 5.4 );
    const val3 = Math.round( utils.formatInt( sum ) * 0.0126 );
    const val4 = Math.round( utils.formatInt( sum ) * 5.4432 );
