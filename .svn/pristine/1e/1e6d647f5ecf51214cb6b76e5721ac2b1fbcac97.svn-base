export default {
  ...
  "info": {
    ...
    "section2": {
      ...
      "data": [{
        ...
        "type": "image",
        "value": "assets/img/projectform/graph/02/graph_AM55.png",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "iconText": "**",
          "color": "c-blue",
          "message": "หากผู้เอาประกันภัยเสียชีวิตโดยที่ยังได้รับเงินบำนาญไม่ครบ 20 ปี บริษัทฯ จะจ่ายเงินบำนาญที่เหลืออยู่ในครั้งเดียวให้ โดยมูลค่าจะเท่ากับมูลค่าปัจจุบันของจำนวนเงินบำนาญที่ยังไม่ได้จ่ายจนครบ 20 ปี {{extendMessage1}}"
        },
        {
          "iconText": "***",
          "color": "c-blue",
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val2 = Math.round( utils.formatInt( sum ) * 4.65 );
    const val3 = Math.round( utils.formatInt( sum ) * 0.0126 );
    const val4 = Math.round( utils.formatInt( sum ) * 4.6872 );
