...
/**
 * Generated class for the NumberCharacterOnlyDirective directive.
 *
...
export const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumberCharacterOnlyDirective),
  multi: true
};

@Directive({
  selector: '[NumberCharacterOnly]', // Attribute selector
  host: {
...
export class NumberCharacterOnlyDirective implements ControlValueAccessor {
                                
  private regex = new RegExp(/^[\u0E01-\u0E4Ca-zA-Z0-9/\-,.()%@&*!+_:\[\] ]+$/);
