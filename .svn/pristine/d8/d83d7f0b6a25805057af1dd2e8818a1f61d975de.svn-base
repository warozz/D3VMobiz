export default {
  "name": "ธนทรัพย์ 15/15 [มีเงินปันผล]",
  "info": {
    "section1": null,
    "section2": {
      "css": {
      ...
      "data": [{
        ...
        "type": "image",
        "value": "assets/img/projectform/graph/01/01_graph48.png",
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val1 = utils.numFormat(Math.round(utils.formatInt(sum)*1.05));
    const val2 = utils.numFormat(Math.round(utils.formatInt(sum)*1.05));
