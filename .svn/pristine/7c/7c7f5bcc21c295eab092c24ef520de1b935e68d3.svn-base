export default {
  ...
  "info": {
    ...
    "section2": {
      ...
      "data": [{
        ...
        "type": "text",
        "value": "คุ้มครองเพิ่ม    1. กรณีเสียชีวิตหรือสูญเสียสายตา มือ เท้าจากอุบัติเหตุ คุ้มครองเพิ่มสูงสุด 100,000 บาท     2. ค่ารักษาพยาบาลรายวันกรณีรักษาตัวในฐานะผู้ป่วยในวันละ 500 บาท",
        "css": {
          "margin-top": "0px",
          "margin-left": "25px",
          "font-size": "18px",
        ...
        "type": "text",
        "value": "ตั้งแต่ปีที่ 2-15 เพิ่มความคุ้มครองปีละ 20%*",
        "css": {
          "margin-top": "20px",
          "margin-left": "380px",
          "font-size": "16px",
        ...
        "type": "image",
        "value": "assets/img/projectform/graph/03/03_graph7.png",
  ...
  "calculate": (sum, prospect, utils) => {
    ...
    const val1 = utils.numFormat(utils.formatInt(SUMFINAL)*4);
    const val2 = utils.numFormat(Math.round((utils.formatInt(SUMFINAL)*0.2)+utils.formatInt(SUMFINAL)));
    const val3 = utils.numFormat(Math.round(((utils.formatInt(SUMFINAL)*0.2)*13)+utils.formatInt(SUMFINAL)));
    const val4 = utils.numFormat(Math.round(((utils.formatInt(SUMFINAL)*0.2)*14)+utils.formatInt(SUMFINAL)));
