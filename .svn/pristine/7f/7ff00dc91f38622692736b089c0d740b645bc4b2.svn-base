export default {
    ...
    "info": {
      ...
      "section2": {
        ...
        "data": [{
          ...
          "type": "image",
          "value": "assets/img/projectform/graph/01/A1_85-1(AS85).png",
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            "iconText": "***",
            "color": "c-blue",
            "message": "ผู้เอาประกันภัยสามารถเลือกรับเงินบำนาญเป็นรายปี ปีละ {{income1}} บาท {{extendMessage2}} ตั้งแต่วันครบรอบปีกรมธรรม์ที่ 1 ไปจนถึงวันครบรอบปีกรมธรรม์ที่อายุครบ 85 ปี"
          }
        ]
      },
      {
    ...
    "calculate": (sum, prospect, utils, quatation) => {
      ...
      const age2 = 85 - Number(prospect.age);
